...
namespace Models
{
    ...
    public class User : Record
    {
        ...
        [JsonIgnore]
        private static List<int> OnlineUsers
        {
            get
            {
                if (HttpContext.Current.Application["OnlineUsers"] == null)
                {
                    HttpContext.Current.Application["OnlineUsers"] = new List<int>();
                }

                return (List<int>)HttpContext.Current.Application["OnlineUsers"];
            }
        }

        public static List<int> GetOnlineUser()
        {
            return OnlineUsers;
        }
    }
